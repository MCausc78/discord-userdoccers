...
| guild?                                | [interaction guild](#interaction-guild-structure) object               | The guild the interaction was created in                                                                          |
...
| ineligible_reason?             | ?integer | The [reason for SKU ineligibility](#sku-ineligibility-reason) |
| ineligible_reason_description? | ?string  | The detailed ineligibility reason (max 255 characters)        |

###### SKU Ineligibility Reason

| Value | Name                         | Description                                        |
| ----- | ---------------------------- | -------------------------------------------------- |
| 0     | OTHER                        | Other                                              |
| 1     | OWNS_SKU_OR_BUNDLE_COMPONENT | User already owns the SKU or one of its components |
| 2     | PLATFORM_RESTRICTION         | User does not have game account linked             |
