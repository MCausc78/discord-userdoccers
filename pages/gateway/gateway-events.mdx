...
| [Guild Room Connect](#guild-room-connect)                                                         | User connected to a guild room                                                                    |
| [Guild Room Disconnect](#guild-room-disconnect)                                                   | User disconnected from a guild room                                                               |
| [Guild Room Update](#guild-room-update)                                                           | Guild room was updated                                                                            |
...
| [Haven Connect](#haven-connect)                                                                   | User connected to a haven                                                                         |
| [Haven Disconnect](#haven-disconnect)                                                             | User disconnected from a haven                                                                    |
| [Haven Update](#haven-update)                                                                     | Haven was updated                                                                                 |
...
| version  | string    | The version of the guild serialized as a stringified integer |

### Guild Rooms

#### Guild Room Connect

Sent when the current user connects to a guild room. The inner payload is a [guild room](/resources/guild#guild-room-object) object.

#### Guild Room Disconnect

Sent when the current user disconnects from a haven.

###### Guild Room Disconnect Structure

| Field   | Type      | Description                      |
| ------- | --------- | -------------------------------- |
| user_id | snowflake | The ID of the user               |
| room_id | snowflake | The ID of the room voice channel |

#### Guild Room Update

Sent when a guild room is updated. The inner payload is a [guild room](/resources/guild#guild-room-object) object.
...
Sent when the current user connects to a haven. The inner payload is a [haven](/resources/haven#haven-object) object.

#### Haven Disconnect

Sent when the current user disconnects from a haven.

###### Haven Disconnect Structure

| Field   | Type      | Description                       |
| ------- | --------- | --------------------------------- |
| user_id | snowflake | The ID of the user                |
| room_id | snowflake | The ID of the haven voice channel |

#### Haven Update

Sent when a haven is updated. The inner payload is a [haven](/resources/haven#haven-object) object.
