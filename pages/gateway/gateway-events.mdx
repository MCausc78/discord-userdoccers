...
| [Content Inventory Inbox Stale](#content-inventory-inbox-stale)                                   | Content inventory inbox is stale and needs to be refreshed                                        |
...
Sent when content inventory inbox is stale and needs to be refreshed.

###### Content Inventory Inbox Stale Structure

| Field             | Type     | Description                                                                          |
| ----------------- | -------- | ------------------------------------------------------------------------------------ |
| refresh_after_ms? | ?integer | Duration in milliseconds after which the content inventory inbox should be refreshed |
