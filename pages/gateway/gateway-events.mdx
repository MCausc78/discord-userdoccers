...
| [Wallet Balance Update](#wallet-balance-update)                                                   | User's wallet balance was updated                                                                 |
...
Sent when the current user's wallet balance is updated.

###### Wallet Balance Update Structure

| Field             | Type      | Description                                                                      |
| ----------------- | --------- | -------------------------------------------------------------------------------- |
| payment_source_id | snowflake | The ID of the payment source                                                     |
| balance           | integer   | Amount of money the user has                                                     |
