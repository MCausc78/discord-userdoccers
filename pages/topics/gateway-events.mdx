...
This event is not sent when using the `PASSIVE_GUILD_UPDATE` or `PASSIVE_GUILD_UPDATE_V2` [Gateway capability](/topics/gateway#gateway-capabilities).
...
Sent periodically when not subscribed to guild.
...
| -------------------- | ------------------------------------------------------------------------- | -------------------------------------------------------- |
| guild_id             | snowflake                                                                 | The ID of the guild                                      |
| channels             | array[[partial channel update](#partial-channel-update-structure) object] | The partial channel updates                              |
| voice_states?        | array[[voice state](/resources/voice#voice-state-object) object]          | The voice states of the guild                            |
| members?             | array[[guild member](/resources/guild#gulid-member-object) object]        | The updated members                                      |
...
| -------------------- | ------------------------------------------------------------------------- | -------------------------------------------------------- |
| guild_id             | snowflake                                                                 | The ID of the guild                                      |
| updated_members      | array[[guild member](/resources/guild#gulid-member-object) object]        | The updated members                                      |
| updated_channels     | array[[partial channel update](#partial-channel-update-structure) object] | The partial channel updates                              |
| updated_voice_states | array[[voice state](/resources/voice#voice-state-object) object]          | The updated voice states                                 |
| removed_voice_states | array[snowflake]                                                          | The IDs of the users who do not have voice state anymore |
