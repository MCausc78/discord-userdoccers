...
#### Message Poll Vote Add Many

Sent when multiple users vote to a poll in a short period of time.

<Alert type="info">

This event requires the `DEBOUNCE_MESSAGE_POLL_VOTES` [Gateway capability](/topics/gateway#gateway-capabilities).

</Alert>

###### Message Poll Vote Add Many Structure
...
| guild_id?  | snowflake                                                           | The ID of the guild         |
| votes      | array[[debounced poll vote](#debounced-poll-vote-structure) object] | The votes added to the poll |

#### Debounced Poll Vote Structure

| Field     | Type    | Description                   |
| --------- | ------- | ----------------------------- |
| answer_id | integer | The answer that was voted for |
...
#### Voice State Update Batch

Sent when multiple users joins/leaves/moves voice channels or calls.

<Alert type="info">

This event requires the `DEBOUNCE_VOICE_STATE_UPDATES` [Gateway capability](/topics/gateway#gateway-capabilities).

</Alert>

###### Voice State Update Batch Structure

| Field        | Type                                                             | Description              |
| ------------ | ---------------------------------------------------------------- | ------------------------ |
| voice_states | array[[voice state](/resources/voice#voice-state-object) object] | The updated voice states |
