...
| [Virtual Currency Balance Update](#virtual-currency-balance-update)                 | Virtual currency balance for current user was updated                                           |
...
Sent when user's virtual currency balance is updated. The inner payload is a [virtual currency balance](/resources/user#virtual-currency-balance-object) object.
