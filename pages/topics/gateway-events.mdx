...
| [Application Command Autocomplete Response](#application-command-autocomplete-response) | Application is autocompleting command option                                                    |
| [Interaction Modal Create](#interaction-modal-create)                                   | Application responded with modal as interaction response                                        |
| [Interaction IFrame Modal Create](#interaction-iframe-modal-create)                     | Application responded with IFrame modal as interaction response                                 |
...
For bots, inner payload is an [Interaction](/interactions/receiving-and-responding#interaction-structure).
