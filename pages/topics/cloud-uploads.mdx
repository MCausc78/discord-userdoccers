...
<RouteHeader method="POST" url="/users/@me/widgets/assets/upload">
  Create Widget Asset Attachment
</RouteHeader>

Creates attachment URL to upload the intended attachment directly to Discord's GCP storage bucket. See [above](#cloud-uploads) for more information.

###### JSON Params

| Field     | Type    | Description                                               |
| --------- | ------- | --------------------------------------------------------- |
| filename  | string  | The name of the file being uploaded (1-128 characters)    |
| file_size | integer | The size of the file being uploaded in bytes (1-10485760) |
...
<RouteHeader method="POST" url="/users/@me/widgets/clips/upload">
  Create Widget Clip Attachment
</RouteHeader>
...
| Field     | Type    | Description                                                |
| --------- | ------- | ---------------------------------------------------------- |
| file_size | integer | The size of the file being uploaded in bytes (1-524288000) |
