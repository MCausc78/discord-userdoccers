...
| Field       | Type                                                                 | Description               |
| ----------- | -------------------------------------------------------------------- | ------------------------- |
| steam?      | [steam game reviews](#steam-game-reviews-structure) object           | The reviews on Steam      |
| opencritic? | [opencritic game reviews](#opencritic-game-reviews-structure) object | The reviews on OpenCritic |

###### Steam Game Reviews Structure
