...
| Field                 | Type                                                             | Description                                                        |
| --------------------- | ---------------------------------------------------------------- | ------------------------------------------------------------------ |
| description?          | ?string                                                          | The summary of the game                                            |
| media?                | [game media assets](#game-media-assets-structure) object         | The media assets of the game                                       |
...
| reviews?              | [game reviews](#game-reviews-structure)                          | The reviews of the game                                            |
...
###### Game Media Assets Structure

| Field           | Type                                                          | Description                                            |
| --------------- | ------------------------------------------------------------- | ------------------------------------------------------ |
| cover_hash?     | string                                                        | The game's [cover hash](/reference#cdn-formatting)     |
| cover_url?      | string                                                        | The URL to the game cover                              |
| artwork_hashes? | array[string]                                                 | The game's [artwork hashes](/reference#cdn-formatting) |
| artwork_urls?   | array[string]                                                 | The URLs to the game artworks                          |
| icon?           | [game media asset](#game-media-asset-structure) object        | The game's icon                                        |
| banner?         | [game media asset](#game-media-asset-structure) object        | The game's banner                                      |
| cover           | [game media asset](#game-media-asset-structure) object        | The game's cover                                       |
| artwork?        | array[[game media asset](#game-media-asset-structure) object] | The game's artworks                                    |

###### Game Media Asset Structure

| Field | Type   | Description                                                |
| ----- | ------ | ---------------------------------------------------------- |
| type  | string | The [type of the game media asset](#game-media-asset-type) |
| value | string | The value of the game media asset                          |

###### Game Media Asset Type

| Value | Description                   |
| ----- | ----------------------------- |
| hash  | The value is a CDN asset hash |
...
| roles | array[integer] | The [roles](#company-role) of the company |

###### Company Role

| Value | Name      | Description                       |
| ----- | --------- | --------------------------------- |
| 1     | PUBLISHER | The company is the game publisher |
| 2     | DEVELOPER | The company is the game developer |

###### Game Reviews Structure

| Field       | Type                                                       | Description               |
| ----------- | ---------------------------------------------------------- | ------------------------- |
| steam?      | [steam reviews](#steam-reviews-structure) object           | The reviews on Steam      |
| opencritic? | [opencritic reviews](#opencritic-reviews-structure) object | The reviews on OpenCritic |

###### Steam Reviews Structure

| Field                   | Type    | Description                                                                                               |
| ----------------------- | ------- | --------------------------------------------------------------------------------------------------------- |
| rating?                 | float   | Overall positive review ratio for the game across all time, as a value between 0 and 100                  |
| rating_count?           | integer | Total number of reviews submitted across all time                                                         |
| recent_rating?          | float   | Positive review ratio calculated from reviews submitted in the last 30 days, as a value between 0 and 100 |
| recent_rating_count?    | integer | Total number of reviews submitted in the last 30 days                                                     |
| localized_rating?       | float   | Positive review ratio filtered to reviews written in the user's locale, as a value between 0 and 100      |
| localized_rating_count? | integer | Total number of reviews written in the user's locale                                                      |

###### OpenCritic Reviews Structure

| Field                   | Type     | Description                                            |
| ----------------------- | -------- | ------------------------------------------------------ |
| top_critic_rating?      | ?float   | The rating on OpenCritic                               |
...
<RouteHeader method="GET" url="/games/autocomplete">

</RouteHeader>

Returns a list of up to 10 [games](#autocompleted-game-structure) based on the provided query.

###### Query String Parameters

| Field | Type   | Description                                |
| ----- | ------ | ------------------------------------------ |
| q     | string | The search query to use (1-100 characters) |

###### Autocompleted Game Structure

| Field     | Type                                                   | Description                                       |
| --------- | ------------------------------------------------------ | ------------------------------------------------- |
| id        | snowflake                                              | The ID of the game                                |
