...
| eligible_offers?                          | array[snowflake]                                                               | The IDs of the user offers eligible for the SKU                                                                     |
| preview_asset_paths?                      | ?[SKU preview assets](#sku-preview-assets-structure) object                    | The SKU preview assets                                                                                              |
...
| 1 \<\< 12 | AVAILABLE_ON_ANDROID               | SKU is available on Android                                         |
| 1 \<\< 13 | AVAILABLE_ON_IOS                   | SKU is available on iOS                                             |
...
^1^ The value can be `discord_orb` to represent price via virtual currency.
...
###### SKU Preview Assets Structure

| Field        | Type   | Description                              |
| ------------ | ------ | ---------------------------------------- |
| fg_static?   | string | The URL to the static foreground image   |
| fg_animated? | string | The URL to the animated foreground image |
| bg_static?   | string | The URL to the static background image   |
| bg_animated? | string | The URL to the animated background image |
...
| price_tier_id?                  | snowflake                                                           | The ID of the price tier                             |
| storefront_item_type?           | ?integer                                                            | The [type of storefront item](#storefront-item-type) |

###### Storefront Item Type
...
| custom_sku_ids | array[string]                                                               | The IDs of the custom SKUs on the page, in the same order as the `sku_ids` array (max 100) |
...
| custom_sku_ids | array[string]    | The IDs of the custom SKUs on the page section, in the same order as the `sku_ids` array (max 100) |
...
| reward_status?      | integer                                                                                        | The [status of storefront promotion reward eligibility](#storefront-promotion-reward-eligibility-status) |
...
| include_bundles     | boolean                                                                                        | Whether the promotion includes bundle SKUs                                                               |
...
| Field         | Type                                                                                                        | Description                            |
| ------------- | ----------------------------------------------------------------------------------------------------------- | -------------------------------------- |
| collectibles? | ?[collectibles promotion metadata](#collectibles-promotion-metadata-structure) object                       | Collectibles promotion data            |
| social_layer? | ?[social layer storefront promotion metadata](#social-layer-storefront-promotion-metadata-structure) object | Social layer storefront promotion data |

###### Collectibles Promotion Metadata Structure

| Field   | Type                                                                                               | Description                      |
| ------- | -------------------------------------------------------------------------------------------------- | -------------------------------- |
| reward? | [collectibles reward promotion metadata](#collectibles-reward-promotion-metadata-structure) object | The information about the reward |

###### Collectibles Reward Promotion Metadata Structure

| Field       | Type                                                                                                       | Description                                |
| ----------- | ---------------------------------------------------------------------------------------------------------- | ------------------------------------------ |
| storefront? | [collectibles promotion metadata storefront](#collectibles-promotion-metadata-storefront-structure) object | The information about the storefront       |
| checkout?   | [collectibles promotion metadata checkout](#collectibles-promotion-metadata-checkout-structure) object     | The information about the checkout         |
| collected?  | [collectibles promotion metadata collected](#collectibles-promotion-metadata-collected-structure) object   | The information about the collected reward |
| flavor?     | ?string                                                                                                    | The flavor                                 |

###### Collectibles Promotion Metadata Storefront Structure

| Field   | Type                                                                                                                     | Description                      |
| ------- | ------------------------------------------------------------------------------------------------------------------------ | -------------------------------- |
| nagbar? | [collectibles promotion metadata storefront nagbar](#collectibles-promotion-metadata-storefront-nagbar-structure) object | The information about the nagbar |

###### Collectibles Promotion Metadata Storefront Nagbar Structure

| Field           | Type                                                                                                                              | Description                       |
| --------------- | --------------------------------------------------------------------------------------------------------------------------------- | --------------------------------- |
| header_text?    | ?string                                                                                                                           | The header text                   |
| cta?            | ?[collectibles promotion metadata storefront nagbar CTA](#collectibles-promotion-metadata-storefront-nagbar-cta-structure) object | The information about the CTA     |
| help_center_id? | ?string                                                                                                                           | The ID of the help center article |
| icon?           | ?unknown                                                                                                                          | Unknown                           |

###### Collectibles Promotion Metadata Storefront Nagbar CTA Structure

| Field | Type    | Description         |
| ----- | ------- | ------------------- |
| text? | ?string | The text on the CTA |

###### Collectibles Promotion Metadata Checkout Structure

| Field         | Type                                                                                                           | Description               |
| ------------- | -------------------------------------------------------------------------------------------------------------- | ------------------------- |
| offer_notice? | [collectibles promotion metadata offer notice](#collectibles-promotion-metadata-offer-notice-structure) object | The checkout offer notice |

###### Collectibles Promotion Metadata Offer Notice Structure

| Field | Type     | Description                  |
| ----- | -------- | ---------------------------- |
| icon? | ?unknown | Unknown                      |
| text? | ?string  | The text on the offer notice |

###### Collectibles Promotion Metadata Collected Structure

| Field           | Type    | Description        |
| --------------- | ------- | ------------------ |
| override_title? | ?string | The title override |

###### Social Layer Storefront Promotion Metadata Structure
...
| Field         | Type      | Description                                                  |
| ------------- | --------- | ------------------------------------------------------------ |
| id            | snowflake | The ID of the storefront discount                            |
| type          | integer   | The [type of storefront discount](#storefront-discount-type) |
| amount        | integer   | How much the discount is                                     |
| fiat_enabled? | boolean   | Unknown                                                      |
| orbs_enabled? | boolean   | Whether the discount applies to Orbs                         |
...
###### Storefront Promotion Reward Eligibility Status

| Value | Name         | Description                     |
| ----- | ------------ | ------------------------------- |
| 1     | EARNED       | Reward is earned                |
| 2     | IN_PROGRESS  | Reward is in progress           |
| 3     | NOT_ELIGIBLE | User is not eligible for reward |
| 4     | CONSUMED     | Reward is consumed              |

###### Storefront Discount Type

| Value | Name    | Description               |
| ----- | ------- | ------------------------- |
| 1     | FLAT    | Flat discount price       |
| 2     | PERCENT | Discount price in percent |
...
<RouteHeader method="GET" url="/partner-sdk/applications/{application.id}/storefront/{storefront.id}/preview">
  Get Application Storefront Preview
</RouteHeader>
...
| announcement_modal_config? | ?[storefront launch announcement modal config](#storefront-launch-announcement-modal-config-structure) object | The config for the storefront launch announcement modal |
...
###### Storefront Launch Announcement Modal Config Structure

| Field          | Type      | Description                                  |
| -------------- | --------- | -------------------------------------------- |
| version        | integer   | The version of the announcement modal config |
| application_id | snowflake | The ID of the application                    |
...
If it exists, returns a response below representing the storefront launch announcement. Otherwise, returns a 204 empty response.
...
| --------------------- | --------------------------------------------------------------------------------------------------------- | ----------------------------------- |
| application_id        | snowflake                                                                                                 | The ID of the application           |
| light_theme_logo_url? | string                                                                                                    | The URL of the logo for light theme |
| dark_theme_logo_url?  | string                                                                                                    | The URL of the logo for dark theme  |
| background_url?       | string                                                                                                    | The URL of the background           |
| titles?               | array[string]                                                                                             | The titles of the announcement      |
| subtitle?             | string                                                                                                    | The subtitle of the announcement    |
| features?             | array[[storefront launch announcement feature](#storefront-launch-announcement-feature-structure) object] | The features of the announcement    |
| button_text?          | string                                                                                                    | The button text of the announcement |

###### Storefront Launch Announcement Feature Structure

| Field     | Type   | Description                       |
| --------- | ------ | --------------------------------- |
| asset_url | string | The URL of the feature asset      |
| title     | string | The title of the feature asset    |
| subtitle  | string | The subtitle of the feature asset |

###### Example Response

```json
{
  "application_id": "614380482620293151",
  "light_theme_logo_url": "https://cdn.discordapp.com/assets/content/a72a057c927f48664f05d63c79d477ab3f8fe89946a06be29c02d0b7242928f8.png",
  "dark_theme_logo_url": "https://cdn.discordapp.com/assets/content/25dd3eedeeeb590419a5399c90020390f8be5214ec6cf6364c0118c172a44fc3.png",
  "background_url": "https://cdn.discordapp.com/assets/content/247bc84fb66c3c9e22d42854bdc16db2ca73068ef6e94077c3193548da480a5f.png",
  "titles": ["Buy it on Discord.", "Get it in Bloons TD 6"],
  "subtitle": "Shop for Bloons TD 6 in-game items on Discord and activate them instantly in-game",
  "features": [
    {
      "asset_url": "https://cdn.discordapp.com/assets/content/344a9498d8e06f1b777d0b29704e209e8b3a00d8d307564c67efb20c17e18feb.png",
      "title": "50% Off. Only on Discord",
      "subtitle": "Launch sale with 50% off everything! Ends Aug 19."
    },
    {
      "asset_url": "https://cdn.discordapp.com/assets/content/d44635d4d81b230ea278dc07cbb89fafc6780c128be6e0380962c4290b6edd5f.png",
      "title": "Free Wumpus Pet!",
      "subtitle": "Get an exclusive Bloons TD 6 Wumpus pet with your first purchase!"
    }
  ],
  "button_text": "Visit the Bloons TD 6 Shop"
}
```
