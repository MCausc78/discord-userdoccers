...
| allowed_countries?                      | array[string]                                                                        | The [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) codes of countries that the promotion is allowed in                |
| country_list_mode?                      | string                                                                               | The [type of country list mode](#country-list-mode)                                                                                           |
...
| metadata?                               | [promotion metadata](#promotion-metadata-structure)                                  | The promotion metadata                                                                                                                        |
| promotion_key?                          | string                                                                               | The promotion key                                                                                                                             |
...
###### Promotion Metadata Structure

| Field              | Type                                                                       | Description                |
| ------------------ | -------------------------------------------------------------------------- | -------------------------- |
| premium_promotion? | [premium promotion metadata](#premium-promotion-metadata-structure) object | Premium promotion metadata |
| gift_promotion?    | [gift promotion metadata](#gift-promotion-metadata-structure) object       | Gift promotion metadata    |

###### Premium Promotion Metadata Structure

| Field           | Type                                                                                                   | Description                |
| --------------- | ------------------------------------------------------------------------------------------------------ | -------------------------- |
| reward_sku_ids? | array[snowflake]                                                                                       | The IDs of the SKU rewards |
| reward_config?  | [premium promotion metadata reward config](#premium-promotion-metadata-reward-config-structure) object | The config for reward      |

###### Gift Promotion Metadata Structure

| Field           | Type             | Description                |
| --------------- | ---------------- | -------------------------- |
| reward_sku_ids? | array[snowflake] | The IDs of the SKU rewards |

###### Premium Promotion Metadata Reward Config Structure

| Field | Type                                                                                                             | Description        |
| ----- | ---------------------------------------------------------------------------------------------------------------- | ------------------ |
| bogo? | [premium promotion metadata BOGO reward config](#premium-promotion-metadata-bogo-reward-config-structure) object | BOGO reward config |

###### Premium Promotion Metadata BOGO Reward Config Structure

| Field    | Type    | Description                            |
| -------- | ------- | -------------------------------------- |
| enabled? | boolean | Whether the reward for BOGO is enabled |
...
| 2     | THIRD_PARTY_DIRECT_FULFILLMENT | Third-party direct fulfillment           |
...
| 7     | THIRD_PARTY_OUTBOUND_RECURRING | Third party outbound recurring promotion |
...
| allowlist | Listed countries are allowed |
...
| Field                     | Type      | Description                                                                                                                                                                                                                   |
| ------------------------- | --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| id                        | snowflake | The ID of the component                                                                                                                                                                                                       |
| promotion_id              | snowflake | The ID of the promotion                                                                                                                                                                                                       |
| premium_offer_type        | integer   | Unknown                                                                                                                                                                                                                       |
| premium_type              | ?integer  | Unknown                                                                                                                                                                                                                       |
| premium_source            | ?integer  | Unknown                                                                                                                                                                                                                       |
| premium_subscription_type | ?integer  | Unknown                                                                                                                                                                                                                       |
| component_type            | integer   | The [type of marketing component](#promotion-marketing-component-type)                                                                                                                                                        |
| theme                     | integer   | Unknown                                                                                                                                                                                                                       |
...
| 5     | GIFT_ICON                          | Gift icon                               |
| 6     | GIFT_ICON_COACHMARK                | Gift icon with a coachmark              |
| 7     | GIFT_PLAN_SELECTION_CARD_BANNER    | Banner in gift plan selection card menu |
| 8     | GIFT_CUSTOMIZATION_BANNER          | Banner in gift customization menu       |
| 9     | BILLING_SETTINGS_NITRO_GIFT_BANNER | Premium gift banner in billing settings |
| 10    | GIFT_REMINDER_NAGBAR               | Gift reminder in nagbar                 |
| 11    | GIFT_REMINDER_COACHMARK            | Gift reminder coachmark                 |
| 12    | PREMIUM_TAB_TOOLTIP                | Tooltip on premium tab                  |
| 13    | PREMIUM_TAB_POPOVER                | Popover on premium tab                  |
| 14    | NAGBAR                             | Nagbar                                  |
| 15    | PLAN_SELECT_CARD_BANNER            | Banner in plan card select menu         |
| 16    | BILLING_SETTINGS_BANNER            | Banner in billing settings              |
