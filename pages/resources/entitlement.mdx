...
| metadata?           | [entitlement metadata](#entitlement-metadata-structure) object                | The entitlement metadata                                                            |
...
###### Entitlement Metadata Structure

| Field                | Type    | Description               |
| -------------------- | ------- | ------------------------- |
| num_expiring_boosts? | integer | Number of expiring boosts |
...
| promotion?            | [promotion](/resources/promotion#promotion-object) object                      | The promotion the gift code is from                          |
