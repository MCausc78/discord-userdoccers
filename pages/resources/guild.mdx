...
| position?    | [guild room user position](#guild-room-user-position-structure) object | The position of the user in the room |
| status_id?   | ???                                                                    | ???                                  |
| status_text? | ???                                                                    | ???                                  |

###### Guild Room User Position Structure
...
| Field    | Type                                                                   | Description  |
| -------- | ---------------------------------------------------------------------- | ------------ |
| position | [guild room user position](#guild-room-user-position-structure) object | The position |
...
| user_position?    | [guild room user position](#guild-room-user-position-structure) object | The position of the user in the room             |
