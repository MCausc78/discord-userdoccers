...
<RouteHeader method="GET" url="/guilds/{guild.id}/roles/member-counts">
  Get Roles Members Count
</RouteHeader>

Returns a mapping of role IDs to members count that have [role](/topics/permissions#role-object).

###### Example Response

```json
{
  "1229729851066552350": 1,
  "1226476317671817256": 1,
  "1195365453816668200": 1,
  "1233367105710063616": 0
}
```
