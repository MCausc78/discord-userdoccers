...
<RouteHeader method="POST" url="/guilds/{guild.id}/bulk-ban" supportsAuditReason mfa supportsBot deprecated>
  Bulk Guild Ban
</RouteHeader>
...
<RouteHeader method="POST" url="/guilds/{guild.id}/bulk-ban/v2" supportsAuditReason mfa supportsBot>
  Bulk Guild Ban V2
</RouteHeader>
...
<RouteHeader method="GET" url="/guilds/{guild.id}/requests" supportsBot>
...
<RouteHeader method="PATCH" url="/guilds/{guild.id}/requests/{guild_join_request.id}" supportsBot>
...
<RouteHeader method="GET" url="/guilds/{guild.id}/embedded-applications">
  Get Guild Embedded Applications
</RouteHeader>

Returns a list of embedded application candidates for an application channel in the guild.
...
| ----------- | --------- | ----------------------------------------------------------------- |
| channel_id? | snowflake | The ID of the channel                                             |
| surface?    | integer   | The [request surface](#embedded-application-list-request-surface) |

###### Embedded Application List Request Surface

| Value | Name        | Description         |
| ----- | ----------- | ------------------- |
| 0     | MAIN        | Main surface        |
| 1     | APP_CHANNEL | Application channel |

###### Response Body

| Field | Type                                                                                      | Description    |
| ----- | ----------------------------------------------------------------------------------------- | -------------- |
| items | array[[embedded application candidate](#embedded-application-candidate-structure) object] | The candidates |

###### Embedded Application Candidate Structure

| Field       | Type                                                                                             | Description          |
| ----------- | ------------------------------------------------------------------------------------------------ | -------------------- |
| application | partial [application](/resources/application#application-object) object                          | The application      |
| status      | [embedded application candidate status](#embedded-application-candidate-status-structure) object | The candidate status |

###### Embedded Application Candidate Status Structure

| Field       | Type    | Description                                                                                                                      |
| ----------- | ------- | -------------------------------------------------------------------------------------------------------------------------------- |
| supported   | boolean | Whether the application is supported for an application channel                                                                  |
| reason? ^1^ | integer | The [reason why the application cannot be used for an application channel](#embedded-application-candidate-ineligibility-reason) |

^1^ Only present if `supported` is false.

###### Embedded Application Candidate Ineligibility Reason

| Value | Name                  | Description                                |
| ----- | --------------------- | ------------------------------------------ |
| 1     | REQUIRES_BOT          | The application bot is not in the guild    |
| 2     | SURFACE_NOT_SUPPORTED | The application is not a embedded activity |
