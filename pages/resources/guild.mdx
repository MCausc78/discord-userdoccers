...
Cancels the given premium guild subscription slot. Fires [User Premium Guild Subscription Slot Update](/topics/gateway-events#user-premium-guild-subscription-slot-update) Gateway event.
...
Uncancels the given premium guild subscription slot. Fires [User Premium Guild Subscription Slot Update](/topics/gateway-events#user-premium-guild-subscription-slot-update) Gateway event.
