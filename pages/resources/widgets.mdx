...
| image?    | ?[widget asset](#widget-asset-structure) object                                         | The image asset on the personal widget section                           | `cover`  |
...
| image?       | ?[widget asset](#widget-asset-structure) object | The image asset in the personal widget section field |

###### Widget Asset Structure

| Field       | Type      | Description                   |
| ----------- | --------- | ----------------------------- |
| file_id     | snowflake | The ID of the file            |
