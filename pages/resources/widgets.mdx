...
| data       | [widget data](#widget-data-structure) object | The data of the widget           |

###### Widget Data Structure

| Field          | Type                                                                         | Description                            | Types                                                 |
| -------------- | ---------------------------------------------------------------------------- | -------------------------------------- | ----------------------------------------------------- |
| type           | string                                                                       | The [type of the widget](#widget-type) | All                                                   |
| games          | array[[widget game](#widget-game-structure) object]                          | The widget's games                     | All except `application`, `personal`, `clips_gallery` |
| application_id | snowflake                                                                    | The application ID                     | `application`                                         |
| header?        | ?string                                                                      | The header                             | `personal`                                            |
| sections?      | ?array[[personal widget section](#personal-widget-section-structure) object] | The sections                           | `personal`                                            |

###### Widget Game Structure
...
| tags?    | array[string] | The [tags](#game-widget-tag) to be displayed below the game in detailed game widgets |

###### Personal Widget Section Structure

| Field     | Type                                                                                    | Description                                                              | Types    |
| --------- | --------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ | -------- |
| type      | string                                                                                  | The [type of the personal widget section](#personal-widget-section-type) | All      |
| title?    | string                                                                                  | The title of the personal widget section                                 | `cover`  |
| subtitle? | string                                                                                  | The subtitle of the personal widget section                              | `cover`  |
| image?    | ?[widget image](#widget-image-structure) object                                         | The image on the personal widget section                                 | `cover`  |
| fields    | array[[personal widget section field](#personal-widget-section-field-structure) object] | The fields on the personal widget section                                | `fields` |

###### Personal Widget Section Field Structure

| Field        | Type                                            | Description                                    |
| ------------ | ----------------------------------------------- | ---------------------------------------------- |
| title?       | string                                          | The title                                      |
| description? | string                                          | The description                                |
| image?       | ?[widget image](#widget-image-structure) object | The image in the personal widget section field |

###### Widget Image Structure

| Field   | Type    | Description             |
| ------- | ------- | ----------------------- |
| file_id | unknown | Unknown                 |
| width   | integer | The width of the imgae  |
| height  | integer | The height of the image |

###### Widget Type

| Value              | Description               | Max Repeating Limit in Widget List |
| ------------------ | ------------------------- | ---------------------------------- |
| favorite_games ^1^ | Favorite game (max 1)     | 1                                  |
| played_games       | Games I Like (max 20)     | 1                                  |
| current_games ^1^  | Games in rotation (max 5) | 1                                  |
| want_to_play_games | Want to play (max 20)     | 1                                  |
| application        | Specific game details     | —                                  |
| personal           | Personal profile widget   | —                                  |
...
| Field                     | Type                                                                                                      | Description                       |
| ------------------------- | --------------------------------------------------------------------------------------------------------- | --------------------------------- |
| primary? **(deprecated)** | [user application profile primary data](#user-application-profile-primary-data-structure) object          | The primary user application data |
| dynamic?                  | array[[user application profile dynamic field](#user-application-profile-dynamic-field-structure) object] | The dynamic user application data |
...
###### User Application Profile Dynamic Field Structure

| Field | Type    | Description                                                                   |
| ----- | ------- | ----------------------------------------------------------------------------- |
| type  | integer | The [type of the dynamic field](#user-application-profile-dynamic-field-type) |
| name  | string  | The name of the dynamic field                                                 |
| value | any     | The value of the dynamic field                                                |
...
| 1     | TEXT   | string                                                                         |
| 2     | NUMBER | integer                                                                        |
| 3     | IMAGE  | [unfurled media item](/resources/components#unfurled-media-item-object) object |
...
| surfaces         | map[string, [widget surface](#widget-surface-structure) object]                    | The surfaces the widget config is displayed on           |
...
| Field      | Type                                                                                | Description                     |
| ---------- | ----------------------------------------------------------------------------------- | ------------------------------- |
| layout     | string                                                                              | The layout used for the surface |
| components | map[string, [widget surface component](#widget-surface-component-structure) object] | The components of the surface   |

###### Widget Surface Component Structure

| Field  | Type                                                                                            | Description                 |
| ------ | ----------------------------------------------------------------------------------------------- | --------------------------- |
| fields | map[string, [widget surface component field](#widget-surface-component-field-structure) object] | The fields of the component |
...
| fallback?         | [widget surface component field](#widget-surface-component-field-structure) object | The fallback value if the value is unavailable           |
...
Replaces the user's profile widgets, and returns a list of [widget](#widget-object) objects which has been put on the user's profile.

###### JSON Params

| Field       | Type                                           | Description                                                            |
| ----------- | ---------------------------------------------- | ---------------------------------------------------------------------- |
| widgets ^1^ | array[partial [widget](#widget-object) object] | The user's game widgets (each [widget type](#widget-type) can be ) ^1^ |
...
| surfaces     | map[string, [widget surface](#widget-surface-structure) object] | The surfaces mapped by [surface type](#widget-surface-type) |
