...
<RouteHeader method="POST" url="/billing/gift-card/view">
  Get Gift Card
</RouteHeader>
...
| Field | Type   | Description                                |
| ----- | ------ | ------------------------------------------ |
| pin   | string | The gift card pin code (max 20 characters) |

<RouteHeader method="POST" url="/billing/gift-card/redeem">
  Redeem Gift Card
</RouteHeader>
...
| ------------- | ------ | --------------------------------------------------------------------------------------- |
| pin           | string | The gift card pin code (max 20 characters)                                              |
| postal_code?  | string | The postal code (max 255 characters)                                                    |
| country_code? | string | The [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) country code |

###### Response Body

| amount   | integer | The amount of currency granted                                                   |
| currency | string  | The upper-cased [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) currency code |