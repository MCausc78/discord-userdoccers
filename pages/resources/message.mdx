...
| mention_games?                | array[[game](/resources/game#game-object) object]                                       | Games specifically mentioned in the message                                                                                               |
| lobby_member?                 | [message lobby member metadata](#message-lobby-member-metadata-object) object           | Lobby member specific metadata for the message                                                                                            |
...
| channel? ^2^                       | [channel](/resources/channel#channel-object) object                                     | The channel the message was sent in                                                        |
...
### Message Lobby Member Metadata Object

###### Message Lobby Member Metadata Structure

| Field           | Type   | Description                                          |
| --------------- | ------ | ---------------------------------------------------- |
| additional_name | string | The additional character display name for the member |
