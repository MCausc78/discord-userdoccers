...
Most embed types are "loosely defined" and, for the most part, are not used by Discord clients for rendering. Embed attributes power what is rendered.
...
| Field         | Type             | Description                                                                                |
| ------------- | ---------------- | ------------------------------------------------------------------------------------------ |
| parse?        | array[string]    | The [allowed mention types](#allowed-mention-type) to parse from the content               |
...
Due to the complexity of possibilities, Discord have included a set of examples and behavior for the allowed mentions field.
