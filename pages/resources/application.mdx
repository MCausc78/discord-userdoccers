...
| steam_recent_rating?       | float                                                                | Positive review ratio calculated from reviews submitted on Steam in the last 30 days, as a value between 0 and 100 |
| steam_recent_rating_count? | integer                                                              | Total number of Steam reviews submitted in the last 30 days                                                        |
| guild_id?                  | snowflake                                                            | The ID of the official game guild                                                                                  |
| announcements_channel_id?  | snowflake                                                            | The ID of the game announcements channel                                                                           |
