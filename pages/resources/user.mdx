...
| colors    | array[integer] | The colors to use encoded as an array of integers representing hexadecimal color codes (amount depends on the effect) |
...
| Value | Name     | Description                                    | Colors |
| ----- | -------- | ---------------------------------------------- | ------ |
| 1     | SOLID    | Displays the first color provided              | 1      |
| 2     | GRADIENT | Two color gradient                             | 1-5    |
| 3     | NEON     | Glow around the name                           | 1      |
| 4     | TOON     | Subtle vertical gradient and stroke            | 1      |
| 5     | POP      | Colored dropshadow                             | 1      |
| 6     | GLOW     | Falls back to gradient                         | 1-5    |
| 7     | PRISM    | Scrolling five color gradient                  | 1-5    |
| 8     | GUMMY    | Four color pattern, letters squash and stretch | 1-5    |
| 1001  | TEST_1   | Falls back to solid                            | 1      |
| 1002  | TEST_2   | Falls back to solid                            | 1      |
| 1003  | TEST_3   | Falls back to solid                            | 1      |
| 1004  | TEST_4   | Falls back to solid                            | 1      |
