...
### Virtual Currency Balance Object

###### Virtual Currency Balance Structure

| Field   | Type    | Description                  |
| ------- | ------- | ---------------------------- |
| balance | integer | The virtual currency balance |
...
<RouteHeader method="POST" url="/virtual-currency/skus/{sku.id}/redeem">
  Redeem Virtual Currency SKU
</RouteHeader>

Redeems the SKU. Returns a 204 empty response on success. Fires [Entitlement Create](/topics/gateway-events#entitlement-create), Payment Update, and [Virtual Currency Balance Update](/topics/gateway-events#virtual-currency-balance-update) Gateway events.

User must have enough currency balance to redeem a SKU.

###### JSON Params

| Field               | Type   | Description                    |
| ------------------- | ------ | ------------------------------ |
| checkout_session_id | string | The ID of the checkout session |

<RouteHeader method="GET" url="/users/@me/virtual-currency/balance">
  Get User Virtual Currency Balance
</RouteHeader>


Returns a [virtual currency balance](#virtual-currency-balance-object) object for the current user.