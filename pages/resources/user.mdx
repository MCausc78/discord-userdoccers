...
| 2     | GRADIENT | Two color gradient                             | 2      |
| 3     | NEON     | Glow around the name                           | 1      |
| 4     | TOON     | Subtle vertical gradient and stroke            | 1      |
| 5     | POP      | Colored dropshadow                             | 1      |
| 6     | GLOW     | Alternate gradient style                       | 1      |
| 7     | PRISM    | Scrolling five color gradient                  | 5      |
| 8     | GUMMY    | Four color pattern, letters squash and stretch | 4      |
