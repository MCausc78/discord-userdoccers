...
| component    | [component](#component-object) object | Inner component of the type [text input](#text-input), [string select](#string-select), [user select](#user-select), [role select](#role-select), [mentionable select](#mentionable-select), [channel select](#channel-select), or [file upload](#file-upload) |
